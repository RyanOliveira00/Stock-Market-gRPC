...
type StockPriceClient interface {
	...
	UpdateStockPriceClientStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UpdateStockPriceRequest, UpdateStockPriceResponse], error)
...
func (c *stockPriceClient) UpdateStockPriceClientStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UpdateStockPriceRequest, UpdateStockPriceResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StockPrice_UpdateStockPriceClientStreamingClient = grpc.ClientStreamingClient[UpdateStockPriceRequest, UpdateStockPriceResponse]
...
type StockPriceServer interface {
	...
	UpdateStockPriceClientStreaming(grpc.ClientStreamingServer[UpdateStockPriceRequest, UpdateStockPriceResponse]) error
...
func (UnimplementedStockPriceServer) GetStockPriceServerStreaming(*StockRequest, grpc.ServerStreamingServer[StockResponse]) error {
	return status.Error(codes.Unimplemented, "method GetStockPriceServerStreaming not implemented")
}
func (UnimplementedStockPriceServer) UpdateStockPriceClientStreaming(grpc.ClientStreamingServer[UpdateStockPriceRequest, UpdateStockPriceResponse]) error {
	return status.Error(codes.Unimplemented, "method UpdateStockPriceClientStreaming not implemented")
}
func (UnimplementedStockPriceServer) GetStockPriceBidirectionalStreaming(grpc.BidiStreamingServer[StockRequest, StockResponse]) error {
	return status.Error(codes.Unimplemented, "method GetStockPriceBidirectionalStreaming not implemented")
}
...
func RegisterStockPriceServer(s grpc.ServiceRegistrar, srv StockPriceServer) {
	// If the following call panics, it indicates UnimplementedStockPriceServer was
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StockPrice_UpdateStockPriceClientStreamingServer = grpc.ClientStreamingServer[UpdateStockPriceRequest, UpdateStockPriceResponse]
...
var StockPrice_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/stock_market.proto",
}
